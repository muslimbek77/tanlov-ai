      ...
      <Card className="border-border shadow-lg">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Theme */}
            <div>
              <label className="block text-sm font-medium text-foreground mb-3">{t('settings.theme')}</label>
        ...
        <CardContent className="space-y-6">
          <div>
            <div className="flex justify-between mb-2">
              <label className="text-sm font-medium text-foreground">{t('settings.similarity_threshold')}</label>
              <span className="text-sm font-bold text-emerald-500">{settings.similarity_threshold}%</span>
            </div>
            <input
              type="range"
              min="50"
              ...
              onChange={(e) => setSettings({...settings, similarity_threshold: parseInt(e.target.value)})}
            />
          ...
          <div>
            <div className="flex justify-between mb-2">
              <label className="text-sm font-medium text-foreground">{t('settings.price_deviation')}</label>
              <span className="text-sm font-bold text-amber-500">{settings.price_deviation_threshold}%</span>
            </div>
            <input
              type="range"
              min="10"
              ...
              onChange={(e) => setSettings({...settings, price_deviation_threshold: parseInt(e.target.value)})}
            />
            <p className="text-xs text-muted-foreground mt-1">
          ...
          <div>
            <label className="block text-sm font-medium mb-2 text-foreground">{t('settings.min_participants')}</label>
            <select
              ...
              onChange={(e) => setSettings({...settings, min_participants_for_analysis: parseInt(e.target.value)})}
            >
