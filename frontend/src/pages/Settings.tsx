  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select
                ...
                className="w-full border border-border rounded-lg px-3 py-3 bg-card focus:outline-none focus:ring-2 focus:ring-primary"
              >
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setSettings({
                  ...settings,
                  price_deviation_threshold: Number(e.target.value),
                })
              }
              className="w-full"
            />
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setSettings({
                  ...settings,
                  min_participants_for_analysis: Number(e.target.value),
                })
              }
      ...
      <Card className="border-border/50 shadow-lg">
        ...
        <CardContent>
          <h3 className="text-xl font-bold">Tanlov AI</h3>
