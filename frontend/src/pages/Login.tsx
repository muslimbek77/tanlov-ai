  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative z-20">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute bottom-10 right-10 w-32 h-32 bg-gradient-to-tr from-pink-400/40 to-orange-400/40 rounded-full blur-2xl animate-float"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/3 w-20 h-20 bg-gradient-to-bl from-green-400/30 to-teal-400/30 rounded-full blur-xl animate-float"
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8 animate-fade-in relative">
          <div className="relative inline-block">
            ...
            <img
              src="/logogold.png"
              alt="Logo"
              className="h-[140px] mx-auto mb-4 relative z-10 drop-shadow-2xl transform hover:scale-105 transition-transform duration-300"
            />
          </div>
        ...
        <Card
          className={`${animationClasses["glass-effect"]} shadow-2xl border-0 animate-slide-up relative overflow-hidden z-30`}
        >
          {/* Card decoration */}
          ...
          <div
            className="absolute -bottom-10 -left-10 w-16 h-16 bg-gradient-to-tr from-blue-400/20 to-cyan-400/20 rounded-full blur-lg animate-float"
            style={{ animationDelay: "2s" }}
          ></div>
