...
const translations: Record<'uz_latn' | 'ru', Record<string, string>> = {
  uz_latn: {
    ...
    'dashboard.tender_analysis_desc': 'AI yordamida tender shartnomasini tahlil qiling va ishtirokchilarni baholang.',
    ...
    'dashboard.antifraud_desc': 'Korrupsiya va firibgarlik belgilarini avtomatik aniqlash.',
    ...
    'antifraud.participants_desc': 'Har bir ishtirokchining taklif narxi va hujjatlari haqida ma\'lumot kiriting',
    ...
    'settings.similarity_desc': 'Ishtirokchining tender talablariga moslik foizi chegarasi',
    'settings.price_deviation': 'Narx og\'ishi chegarasi',
    'settings.price_deviation_desc': 'Narx og\'ishi shubhali deb hisoblanadigan chegara',
    'settings.min_participants': 'Minimal ishtirokchilar',
    'settings.min_participants_desc': 'Tahlil uchun minimal ishtirokchilar soni',
    'settings.save': 'Saqlash',
    'settings.saved': 'Saqlandi!',
    'settings.about': 'Tizim haqida',
    'settings.version': 'Versiya',
    'settings.about_desc': 'Tanlov AI - tender jarayonlarini sun\'iy intellekt yordamida tahlil qilish tizimi. Ishtirokchilarni baholash, firibgarlikni aniqlash va muvofiqlikni tekshirish imkoniyatlarini taqdim etadi.',
  ...
  ru: {
    ...
    'dashboard.tender_analysis_desc': 'Анализируйте тендерные документы и оценивайте участников с помощью ИИ.',
    ...
    'dashboard.antifraud_desc': 'Автоматическое выявление признаков коррупции и мошенничества.',
    ...
    'analysis.add_participant_hint': 'Нажмите "Добавить" для добавления участника',
    ...
    'antifraud.subtitle': 'Выявление признаков коррупции и мошенничества с помощью ИИ',
    'antifraud.price_anomaly': 'Ценовые аномалии',
    'antifraud.price_anomaly_desc': 'Необычно низкие/высокие цены, согласованные цены, демпинг',
    'antifraud.doc_similarity': 'Сходство документов',
    'antifraud.doc_similarity_desc': 'Одинаковые шаблоны, метаданные, ошибки форматирования',
    'antifraud.collusion': 'Согласованные предложения',
    'antifraud.collusion_desc': 'Связанные компании, заранее согласованный победитель',
    ...
    'antifraud.participants_desc': 'Введите информацию о предложении и документах каждого участника',
    ...
    'settings.similarity_desc': 'Порог процента соответствия участника требованиям тендера',
    'settings.price_deviation': 'Порог отклонения цены',
    'settings.price_deviation_desc': 'Порог, при котором отклонение цены считается подозрительным',
    'settings.min_participants': 'Минимум участников',
    'settings.min_participants_desc': 'Минимальное количество участников для анализа',
    'settings.save': 'Сохранить',
    'settings.saved': 'Сохранено!',
    'settings.about': 'О системе',
    'settings.version': 'Версия',
    'settings.about_desc': 'Tanlov AI - система анализа тендерных процессов с помощью искусственного интеллекта. Предоставляет возможности оценки участников, выявления мошенничества и проверки соответствия.',
