...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen relative z-10">
      {/* Header */}
      <header className="sticky top-0 z-40 w-full relative h-[76px]">
          ...
          <div className="px-4 py-3 flex items-center justify-between relative z-10 w-full max-w-full h-full">
            <div className="flex items-center space-x-4 flex-shrink-0">
              ...
              <Link to="/" className="cursor-pointer group flex-shrink-0">
                <div className="relative">
                  <img src="/kqlogo.png" alt="Logo" className="h-[90px] transition-all duration-300 group-hover:scale-110 drop-shadow-xl" />
                  ...
                  <div className="absolute -top-2 -right-2 w-4 h-4 bg-yellow-400 rounded-full animate-pulse opacity-80"></div>
                </div>
              </Link>
            </div>
            ...
            <div className="flex items-center space-x-3 flex-shrink-0">
              ...
              >
                ...
                <span className="relative z-10 font-semibold">{languageLabel()}</span>
              </Button>
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/20 to-white/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700"></div>
                {theme === 'dark' ? <Sun className="h-4 w-4 relative z-10" /> : <Moon className="h-4 w-4 relative z-10" />}
              </Button>
      ...
      <div className="flex h-screen">
        ...
        `}>
          ...
          <div className="absolute bottom-10 left-10 w-16 h-16 bg-gradient-to-tr from-blue-400/15 to-cyan-400/15 rounded-full blur-lg animate-float" style={{ animationDelay: '2s' }}></div>
